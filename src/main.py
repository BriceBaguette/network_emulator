...
def main():
    ...
    parser.add_argument('-r', '--generation_rate', type=int,
                        default=20, help='Generation rate in packets per second (default: 1000)')
    ...
    net_sim.ipm_session("1.1.1.1", "1.1.1.5")
    #net_sim.add_hw_issue(400,1000,"6569f30442e7f25d7a592660")
    #net_sim.all_ipm_session()
    #net_sim.hw_issue_detection(sink_dataframe=pd.read_csv("./src/results/sink.csv"), source_measure_file="./src/results/source.csv",latency=True)
